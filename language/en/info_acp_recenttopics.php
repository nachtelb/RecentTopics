...
$lang = array_merge(
	...
	'RT_PAGE_NUMBER'                => 'Full displaying of recent topics pages',
	'RT_PAGE_NUMBER_EXP'            => 'Check to disable the full displaying of the recent topics pagination. If activated, all topics of the board will be paginated with all necessary pages (not recommended). If disabled, fill a number of pages to display in the option “Maximum number of pages”.',
	...
	'RT_ANTI_TOPICS_EXP'            => 'The IDs of topics to exclude, separated by "," (Example: 7,9)<br />The value O disables this behaviour.',
